...
under `assets/illustrations/recipes/` (SVG or a raster, raster preferred when
both exist — see the README's Illustrations section). To stay coherent, keep the
whole set in one locked style:
